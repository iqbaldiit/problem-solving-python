# Source: https://leetcode.com/problems/find-the-highest-altitude/solutions/6411323/simple-best-solution-by-iqbaldiit-ggi1/
'''
...
def largestAltitude(gain: list[int]) -> int:
    nMaxAltitude,nCurrentAltitude=0,0
    for g in gain:
        nCurrentAltitude+=g        
        nMaxAltitude=max(nMaxAltitude,nCurrentAltitude)
    return nMaxAltitude
